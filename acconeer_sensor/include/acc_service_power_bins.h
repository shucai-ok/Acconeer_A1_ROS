 ...
 */
typedef void (acc_power_bins_callback_t)(const acc_service_handle_t service_handle, const float *power_bins_data,
 ...
 */
extern acc_service_status_t acc_service_power_bins_get_next(acc_service_handle_t handle, float *power_bins_data, uint16_t power_bins_data_length,
 ...
 * @return Service status
 */
extern acc_service_status_t acc_service_power_bins_execute_once(acc_service_handle_t handle, float *power_bins_data, uint16_t power_bins_data_length,
                                                                acc_service_power_bins_result_info_t *result_info);
