 ...
 */
typedef void (acc_envelope_callback_t)(const acc_service_handle_t service_handle, const uint16_t *envelope_data,
 ...
 */
extern void acc_service_envelope_envelope_callback_set(acc_service_configuration_t service_configuration, acc_envelope_callback_t *envelope_callback,
                                                       void *user_reference);
 ...
 * @return Service status
 */
extern acc_service_status_t acc_service_envelope_execute_once(acc_service_handle_t handle, uint16_t *envelope_data, uint16_t envelope_data_length,
                                                              acc_service_envelope_result_info_t *result_info);
