 ...
 */
typedef void (acc_iq_float_callback_t)(const acc_service_handle_t service_handle, const float complex *iq_data,
 ...
 */
extern void acc_service_iq_iq_float_callback_set(acc_service_configuration_t service_configuration, acc_iq_float_callback_t *callback,
                                                 void *user_reference);
 ...
 */
extern acc_service_status_t acc_service_iq_get_next(acc_service_handle_t handle, float complex *iq_data, uint16_t iq_data_length,
 ...
 * @return Service status
 */
extern acc_service_status_t acc_service_iq_execute_once(acc_service_handle_t handle, float complex *iq_data, uint16_t iq_data_length,
                                                        acc_service_iq_result_info_t *result_info);
