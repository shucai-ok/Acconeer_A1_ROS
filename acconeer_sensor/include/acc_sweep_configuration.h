 ...
 */
void acc_sweep_configuration_repetition_mode_streaming_set(acc_sweep_configuration_t configuration, float sensor_sweep_frequency_hz);
...
/**
 * @brief Get sweeps per result
 *
 * Gets the number of sweeps that will be returned in each result from the service.
 *
 * @param[in] configuration The sweep configuration to get sweeps per result from
 * @return sweeps per result
 */
uint8_t acc_sweep_configuration_sweeps_per_result_get(const acc_sweep_configuration_t configuration);


/**
 * @brief Set sweeps per result
 *
 * Sets the number of sweeps that will be returned in each result from the service.
 *
 * @param[in] configuration The sweep configuration to set sweeps per results in
 * @param[in] sweeps Sweeps per result, must be a number between 1 and 16
 */
void acc_sweep_configuration_sweeps_per_result_set(acc_sweep_configuration_t configuration, uint8_t sweeps);
